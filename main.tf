...
variable "params" {
  default = [
    ...
    { name = "roboshop.dev.shipping.cart_endpoint", value = "cart-dev.sandeepreddymunagal123.xyz:80", type = "String" },
    { name = "roboshop.dev.shipping.db_host", value = "mysql-dev.sandeepreddymunagal123.xyz:8080", type = "String" },
